...
```bash
# If app.py is in root directory (Streamlit Cloud deployment)
streamlit run app.py

# Or if app.py is in dashboard directory (local development)
...
├── tests/
├── app.py                               # Streamlit dashboard (root for deployment)
├── requirements.txt
├── .env.example
├── ARCHITECTURE.md
└── README.md
